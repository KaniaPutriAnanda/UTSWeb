<?php
    ...
    if(isset($_POST['kirim'])){
        ...
        "INSERT INTO pesanan (nama, nohp, kategori, versi, kuantitas, harga, tanggal, alamat, pembayaran) 
...
<head>
    ...
    <link rel="stylesheet" href="kacans.css?vi">
...
<div class="logo">
    ...
    <div class="all"><a href="all.php">See All</a></div>
